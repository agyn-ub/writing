...
export default function GeneralTask1Page() {
  ...
  useEffect(() => {
    async function fetchEssays() {
      try {
        const response = await fetch('/api/essay-bank?type=GENERAL_TASK1');
        if (!response.ok) {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-6">General Task 1 Essays</h1>
